            ...
            <div class="well span9">
                <s:form namespace="/qode" action="search" theme="simple" cssClass="form-inline">
                    <div class="row-fluid">
                        <div class="span3 lightblue">
                            <label>面额</label>
                            <input type="text" name="qode.type" class="input-meduim">
                        </div>
                        <div class="span3 lightblue">
                            <label>状态</label>
                            <s:select name="qode.valid" list="#{'-1':'所有', '0':'未使用', '1':'已使用'}" />
                        </div>
                        <div class="span3 lightblue">
                            <label>地市</label>
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <tbody>
                        <s:if test="#QODE_LIST.content.size == 0">
                            <tr>
                                <td colspan="5" style="font-weight: bold;color: red;text-align: center;">很遗憾，当前没有导入字符串信息！</td>
                            </tr>
                        </s:if>
                ...
                <div class="pagination pagination-right">
                    <ul>
                        ...
                        <s:if test="#QODE_LIST.currentPage == #QODE_LIST.previousPage">
                            ...
                            <li>
                                <s:a namespace="/qode" action="index">
