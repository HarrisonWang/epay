...
<head>
    ...
    $(function() {
        $("#user-export").click(function() {
            var url = $(this).attr("action") + "?beginDate=" + $("#beginDate").val() + "&user.userId=" + $("#userId").val() + "&user.areaCode=" + $("#areaCode").val() + "&user.type=" + $("#userType").val() + "&user.accountNumber=" + $("#accountNumber").val();
            if ($("input[name='bizType']:checkbox:checked").length > 0) {
	        	$("input[name='bizType']:checkbox:checked").each(function(){
	        		url += "&bizType=" + this.value;
	            });
	                ...
	                <div class="row-fluid">
	                    <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="userId" class="input-meduim" name="user.userId">
                                </div>
                            </div>
                        </div>
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="beginDate" class="input-meduim" name="user.createTime">
                                </div>
                            </div>
                        </div>
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="accountNumber" class="input-meduim" name="user.accountNumber" placeholder="账户ID">
                                </div>
                            </div>
                        </div>
                    </div>
	                <div class="row-fluid">
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <s:select id="areaCode" cssClass="input-meduim" name="user.areaCode" list="#{'': '所有', '0730':'岳阳市', '0731':'长沙市', '0732':'湘潭市', '0733':'株洲市', '0734':'衡阳市', '0735':'郴州市', '0736':'常德市', '0737':'益阳市', '0738':'娄底市', '0739':'邵阳市', '0743':'湘西州', '0744':'张家界', '0745':'怀化市', '0746':'永州市'}"/>
                                </div>
                            </div>
                        </div>
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select id="userType" name="user.type" class="input-meduim">
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <tbody>
                        <s:if test="#LIST_USER.content.size == 0">
                            <tr>
                                <td colspan="7" style="font-weight: bold;color: red;text-align: center;">很遗憾，当前没有用户信息！</td>
                            </tr>
                        </s:if>
                ...
                <div class="pagination pagination-right">
                    <ul>
                        ...
                        <s:if test="#LIST_USER.currentPage == #LIST_USER.previousPage">
                            ...
                            <li>
                                <s:a namespace="/user" action="index">
                                    <s:param name="userName" value="#KEYWORD"/>
