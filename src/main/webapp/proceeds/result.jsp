                    ...
                    <div class="row-fluid">
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="proceeds.beginDate" id="beginDate" class="input-meduim" value="<s:property value='proceeds.beginDate' />">
                                </div>
                            </div>
                        </div>
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="proceeds.endDate" id="endDate" class="input-meduim" value="<s:property value='proceeds.endDate' />">
                                </div>
                            </div>
                        </div>
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="accountName" name="proceeds.accountName" value="<s:property value='proceeds.accountName' />">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
		                            <s:select id="bizType" name="proceeds.bizType" list="#{'-1': '所有', '0':'QQ币', '1':'黄金岛'}" value="proceeds.bizType"/>
                                </div>
                            </div>
                        </div>
                        <div class="span6">
                ...
                <div class="pagination pagination-right">
                    <ul>
                        ...
                        <s:if test="#PROCEEDS_LIST.currentPage == #PROCEEDS_LIST.previousPage">
                            ...
                            <li>
                                <s:a namespace="/proceeds" action="search">
                                    <s:param name="proceeds.beginDate" value="proceeds.beginDate"/>
                                    <s:param name="proceeds.endDate" value="proceeds.endDate"/>
