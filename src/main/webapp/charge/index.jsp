            ...
            <div class="well span9">
	                ...
	                <div class="row-fluid">
	                    <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="beginDate" class="input-meduim" id="beginDate">
                                </div>
                            </div>
                        </div>
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="endDate" class="input-meduim" id="endDate">
                                </div>
                            </div>
                        </div>
	                    <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="userId" name="user.userId" class="input-meduim">
                                </div>
                            </div>
                        </div>
                    </div>
	                <div class="row-fluid">
	                    <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="accountNumber" name="user.accountNumber" class="input-meduim">
                                </div>
                            </div>
                        </div>
	                    <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <s:select id="status" name="status" cssClass="input-meduim" list="#{'-1':'所有', '0':'成功', '1':'失败'}"/>
                                </div>
                            </div>
                        </div>
	                    <div class="span4">
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <tbody>
                        <s:if test="#LIST_FILL_LOGS.content.size == 0">
                            <tr>
                                <td colspan="6" style="font-weight: bold;color: red;text-align: center;">很遗憾，当前没有预付款信息！</td>
                            </tr>
                        </s:if>
                ...
                <div class="pagination pagination-right">
                    <ul>
                        ...
                        <s:if test="#LIST_FILL_LOGS.currentPage == #LIST_FILL_LOGS.previousPage">
                            ...
                            <li>
                                <s:a namespace="/charge" action="index">
