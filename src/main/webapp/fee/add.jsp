...
<head>
    ...
    $(function (){
    	var city = $('#areaCode option:selected').text();
        $("#city").val(city);
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="well span9">
                <s:form action="save" namespace="/fee" theme="simple" method="post" cssClass="form-horizontal">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <s:select id="areaCode" name="fee.areaCode" list="#{'0730':'岳阳市', '0731':'长沙市', '0732':'湘潭市', '0733':'株洲市', '0734':'衡阳市', '0735':'郴州市', '0736':'常德市', '0737':'益阳市', '0738':'娄底市', '0739':'邵阳市', '0743':'湘西州', '0744':'张家界', '0745':'怀化市', '0746':'永州市'}" value="fee.areaCode" cssClass="input-meduim" />
                            <input type="hidden" id="city" name="fee.city">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">业务</label>
                        <div class="controls">
                            <select name="fee.type" class="input-meduim">
