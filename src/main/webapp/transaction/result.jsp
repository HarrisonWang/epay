...
<head>
    ...
    $(function() {
        $("#transaction-export").click(function() {
            var url = $(this).attr("action") + "?beginDate=" + $("#beginDate").val() + "&endDate=" + $("#endDate").val() + "&status=" + $("#status").val() + "&user.accountNumber=" + $("#accountId").val() + "&user.bizType=" + $("#bizType").val();;
            ...
            <div class="well span9">
                   ...
                   <div class="row-fluid">
                        <div class="span4">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="user.accountNumber" value="<s:property value='user.accountNumber'/>" id="accountId" class="input-meduim" placeholder="账户ID">
                                </div>
                            </div>
                        </div>
                        <div class="span4">
                ...
                <table class="table table-striped table-bordered table-condensed">
                    ...
                    <tbody>
                        <s:if test="#TRADE_LOGS.content.size == 0">
                            <tr>
                                <td colspan="10" style="font-weight: bold;color: red;text-align: center;">很遗憾，没有找到您想要的，换个条件试试？</td>
                            </tr>
                        </s:if>
                ...
                <div class="pagination pagination-right">
                    <ul>
                        ...
                        <s:if test="#TRADE_LOGS.currentPage == #TRADE_LOGS.previousPage">
                            ...
                            <li>
                                <s:a namespace="/transaction" action="search">
                                    <s:param name="user.accountNumber" value="user.accountNumber"/>
                                    <s:param name="beginDate" value="beginDate"/>
                                    <s:param name="endDate" value="endDate"/>
                                    <s:param name="user.bizType" value="user.bizType"/>
